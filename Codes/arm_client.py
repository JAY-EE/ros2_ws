...
class ArmClient(Node):
    ...
    def update_joystick(self):
        ...
        self.ac1_rev = self.joystick.get_button(6)
        self.ac2_fwd = self.joystick.get_button(5)
        self.ac2_rev = self.joystick.get_button(7)
        ...
        self.grip_open = self.joystick.get_button(1)
        self.grip_close = self.joystick.get_button(3)
        ...
        # self.step3_axis = self.joystick.get_axis(2)
