...
#define diff_m2_pwm 32
#define diff_m2_dir 33 
...
void setup() {
  ...
  pinMode(bump_down, INPUT_PULLDOWN); 
  attachInterrupt(digitalPinToInterrupt(bump_down), buttonISR, RISING);
