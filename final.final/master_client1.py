...
class WebSocketClient(Node):
    ...
    async def send_arm_server(self, message):
        ...
        if websocket_arm:
            try:
                ...
                await self.setup_connections()  # Retry 
    ...
    def callback_chassis(self, msg):
        ...
        # print(f"Chassis Command: x={x}, y={y}, z={p}, ang_z={ang_z}")
    ...
    async def send_rover_server(self, msg):
        ...
        if websocket_rover:
            try:
                # self.get_logger().info(f"Sending to rover server: {msg}")
                ...
                await self.setup_connections()  # Retry the connection
